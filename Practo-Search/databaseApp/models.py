...
class Doctor(Base):
	...
	#relationships
	experiences = relationship('Experience', backref = 'doctor_experience', lazy = 'dynamic')
	doc_clinic_links = relationship('Doctor_Clinic_Link', backref = 'doc_link', lazy = 'dynamic')
	specialities = relationship('Speciality', backref = 'doctor_speciality', lazy = 'dynamic')
	qualifications = relationship('Qualification', backref = 'doctor_qualification', lazy = 'dynamic')
...
class Doctor_Clinic_Link(Base):
	...
	start_time = Column(String(10), nullable = False, primary_key = True)
	...
	def __init__(self, doctor_id, clinic_id, start_day, end_day, start_time, end_time, fees, contact_num, services):
